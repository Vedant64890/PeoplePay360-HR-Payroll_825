...
export const resources = {
  ...
  structures: { model: "salaryStructure", search: ["code", "name"], include: { category: true, rules: { orderBy: { sequence: "asc" }, include: { salaryRule: { include: { category: true } } } } } },
  ...
  attendance: { model: "attendance", search: ["notes"], include: { day: { include: { employee: { select: { id: true, firstName: true, lastName: true, employeeCode: true, department: { select: { name: true } }, manager: { select: { firstName: true, lastName: true } } } } } }, corrections: true }, workflow: true },
