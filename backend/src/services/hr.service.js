...
export async function hrLookups() {
  ...
  return hrData({ employees, departments, positions, schedules, leaveTypes, settings: { organizationName: settings.organizationName, supportEmail: settings.supportEmail, timezone: settings.timezone, defaultCurrency: settings.defaultCurrency } });
}
